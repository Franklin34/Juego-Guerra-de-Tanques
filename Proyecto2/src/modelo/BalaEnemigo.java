 ...
 * @author Usuario
 */
public class BalaEnemigo extends ObjetosMovibles{

    
    public BalaEnemigo(Vector2D posicion, BufferedImage imagen, Vector2D velocidad,double angulo, double maxV,JuegoActual actual) {
